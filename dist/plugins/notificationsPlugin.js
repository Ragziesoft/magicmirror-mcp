...
const notificationsPlugin = {
    ...
    async register(server, context) {
        ...
        server.tool("mirror.notification.send", "Send a MagicMirror notification to trigger module behaviour. Use 'SHOW_ALERT' to display a popup, or any module-specific notification string.", {
        ...
        server.tool("mirror.alert.show", "Display an alert popup on the MagicMirror screen with a title and message", {
        ...
        server.tool("mirror.alert.hide", "Dismiss the currently displayed alert popup on the MagicMirror", {}, async () => {
            try {
