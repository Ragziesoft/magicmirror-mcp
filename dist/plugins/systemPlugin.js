...
const systemPlugin = {
    ...
    async register(server, context) {
        ...
        server.tool("system.schema", "Discover the capabilities of the connected MagicMirror and Home Assistant. Returns a list of installed mirror modules and available HA entity IDs so the AI agent can understand what is available to control.", {}, async () => {
            try {
